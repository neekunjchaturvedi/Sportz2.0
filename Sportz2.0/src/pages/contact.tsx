...
const ContactForm = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row bg-white rounded-lg shadow-md max-w-6xl mx-8 sm:mx-auto mb-8 space-x-4 ">
      {/* Left Section - Get in Touch */}
      <div className="bg-yellow-50 p-8 md:w-1/3 rounded-l-lg">
        ...
        <div className="mb-6">
          <h3 className="font-semibold text-gray-800 mb-2">Chat to us</h3>
          <p className="text-gray-600">
            Lorem ipsum dolor sit amet pretium consectetur adipiscing elit.
          </p>
        </div>
